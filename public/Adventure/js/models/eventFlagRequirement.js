Adventure.EventFlagRequirementModel = Backbone.Model.extend({
	defaults:{
		name: '',
		conditionID: 1,
		flagID: 0,
	...
	urlRoot: 'services/eventFlagRequirement.php',
	validate: function(){
...
Adventure.EventFlagRequirements = Backbone.Collection.extend({
	model: Adventure.EventFlagRequirementModel
});